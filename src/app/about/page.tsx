...
export const metadata: Metadata = {
  ...
  description:
    "Why we built HalalChain — a halal cold chain traceability platform for Indonesia's fish logistics.",
  openGraph: {
    title: "About — HalalChain",
    description:
      "Why we built HalalChain — a halal cold chain traceability platform for Indonesia's fish logistics.",
      ...
      <section className="border-b border-border bg-surface-muted">
        <div className="mx-auto max-w-4xl px-6 py-20 md:py-28">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">
            A platform built at the dockside, not in a boardroom.
          </h1>
          <p className="mt-5 text-lg text-muted-foreground">
            HalalChain was designed alongside fishery exporters, cold storage operators, and MUI
            LPPOM auditors in Jakarta, Bitung, and Makassar — to make halal cold chain traceability
            a first-class operational discipline.
          </p>
        </div>
      </section>
          ...
          {[
            {
              i: Target,
              t: "Our mission",
              d: "Make halal integrity verifiable end-to-end — from vessel to receiver — with zero paperwork friction.",
            },
            {
              i: ShieldCheck,
              t: "Our principles",
              d: "Operational clarity. Auditable records. No theatre. Every claim must be a record.",
            },
            {
              i: Anchor,
              t: "Our roots",
              d: "Built with Indonesia's fisheries in mind, integrated with STELINA from day one.",
            },
          ].map((b) => (
