...
export const metadata: Metadata = {
  ...
  description:
    "Talk to the HalalChain operations team about deploying halal cold chain traceability.",
  openGraph: {
    title: "Contact — HalalChain",
    description:
      "Talk to the HalalChain operations team about deploying halal cold chain traceability.",
      ...
      <section className="border-b border-border bg-surface-muted">
        <div className="mx-auto max-w-4xl px-6 py-20">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">
            Let's get your shipments traced.
          </h1>
          <p className="mt-4 text-lg text-muted-foreground">
            Operations, integration, or audit questions — we route you to the right desk within one
            business day.
          </p>
        </div>
      </section>
        ...
        <form className="md:col-span-2 rounded-xl border border-border bg-surface p-6 shadow-card">
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <Input className="mt-1.5" placeholder="Anwar Hidayat" />
            </div>
            <div>
              <Label>Company</Label>
              <Input className="mt-1.5" placeholder="PT Mina Bahari" />
            </div>
            <div>
              <Label>Email</Label>
            ...
            <div>
              <Label>Phone</Label>
              <Input className="mt-1.5" placeholder="+62 ..." />
            </div>
          </div>
          <div className="mt-4">
            ...
            <Textarea
              ...
              placeholder="Tell us about your fleet, cold chain SOPs, and integration needs."
            />
          </div>
