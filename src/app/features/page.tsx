...
export const metadata: Metadata = {
  ...
  description:
    "GPS, temperature, humidity, RFID/NFC, STELINA integration — every capability in HalalChain.",
  openGraph: {
    title: "Features — HalalChain",
    description:
      "GPS, temperature, humidity, RFID/NFC, STELINA integration — every capability in HalalChain.",
    ...
    items: [
      {
        i: MapPin,
        t: "GPS Tracking",
        d: "Sub-30s telemetry with route corridors and ETA refinement.",
      },
      {
        i: Thermometer,
        t: "Temperature Sensors",
        d: "Per-reefer continuous logging with profile thresholds.",
      },
      ...
      <section className="border-b border-border bg-surface-muted">
        <div className="mx-auto max-w-4xl px-6 py-20 md:py-24">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">
            Every signal, in one operational fabric.
          </h1>
          <p className="mt-4 text-lg text-muted-foreground">
            A complete capability set for halal fish logistics — designed to feel familiar to fleet
            operators and reassuring to auditors.
          </p>
        </div>
      </section>
