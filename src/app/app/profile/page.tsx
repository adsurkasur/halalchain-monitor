        ...
        <div className="rounded-xl border border-border bg-surface p-6 shadow-card lg:col-span-2">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <Input className="mt-1.5" defaultValue="Fishery Exporter" />
            </div>
            <div>
              <Label>NPWP</Label>
              <Input className="mt-1.5" defaultValue="01.234.567.8-091.000" />
            </div>
            <div>
              <Label>MUI LPPOM ID</Label>
              <Input className="mt-1.5" defaultValue="LPPOM-EXP-09182" />
            </div>
            <div>
              <Label>STELINA account</Label>
              <Input className="mt-1.5" defaultValue="STL-OPR-019823" />
            </div>
            <div>
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-border bg-surface p-6 shadow-card">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-status-safe-soft px-2.5 py-1 text-xs font-medium text-status-safe">
