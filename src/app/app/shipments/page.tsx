      ...
      <div className="flex flex-wrap items-center gap-2 rounded-xl border border-border bg-surface p-3 shadow-card">
        <div className="relative flex-1 min-w-60">
          ...
          <Input
            ...
            placeholder="Search shipment ID, product, driver…"
          />
        </div>
        {["All status", "In transit", "Delivered", "Cold chain risk", "Validation pending"].map(
          (f, i) => (
              ...
              {shipments.map((s) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-xs text-muted-foreground">
                    <div className="max-w-[200px] truncate">{s.origin}</div>
                    <div className="max-w-[200px] truncate">→ {s.destination}</div>
                  </td>
