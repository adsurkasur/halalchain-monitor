...
export default function Scan() {
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Tap or scan to verify shipment authenticity and halal integrity at handover."
    >
        ...
        <div className="rounded-xl border border-border bg-surface p-6 shadow-card">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => setResult("idle")}>
                Reset
              </Button>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-surface-muted py-16">
            <div
              className={`relative flex h-44 w-44 items-center justify-center rounded-full bg-surface shadow-elevated ${result === "idle" ? "animate-pulse" : ""}`}
            >
            ...
            <div className="mt-6 text-center">
              ...
              <div className="mt-1 text-xs text-muted-foreground">
                Hold the receiver device against the RFID tag on the shipment seal
              </div>
            </div>
            <div className="mt-6 flex flex-wrap justify-center gap-2">
              <Button size="sm" onClick={() => setResult("success")} className="gap-2">
            ...
            <div className="mt-3 space-y-3">
              <div className="rounded-lg border border-border bg-surface-muted p-3">
                ...
                <div className="text-xs text-muted-foreground">
                  PT Mina Bahari → Cold Storage Surabaya
                </div>
              </div>
              ...
              <div className="rounded-lg border border-border bg-surface-muted p-3 text-xs">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono">-18.4°C avg</span>
                </div>
                <div className="flex items-center justify-between mt-1">
                  ...
                  <span className="font-mono">MUI-LPPOM-00482-24</span>
                </div>
                <div className="flex items-center justify-between mt-1">
                  <span className="text-muted-foreground">Timestamp</span>
                  <span className="font-mono">2026-05-20 18:38:12 WIB</span>
                </div>
              </div>
