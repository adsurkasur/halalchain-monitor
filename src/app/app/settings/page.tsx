...
export default function Settings() {
  return (
    <DashboardLayout
      title="Settings"
      subtitle="Notifications, monitoring thresholds, and security."
    >
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="rounded-xl border border-border bg-surface p-6 shadow-card">
          <h3 className="text-sm font-semibold">Notification preferences</h3>
          <p className="mt-1 text-xs text-muted-foreground">
            Choose how operational alerts reach your team.
          </p>
        ...
        <section className="rounded-xl border border-border bg-surface p-6 shadow-card">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Defaults applied to new shipments — override per profile.
          </p>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div>
              <Label>Humidity lower (%)</Label>
              <Input className="mt-1.5" type="number" defaultValue="75" />
            </div>
            <div>
              <Label>Humidity upper (%)</Label>
              <Input className="mt-1.5" type="number" defaultValue="85" />
            </div>
            <div>
              <Label>GPS deviation (km)</Label>
              <Input className="mt-1.5" type="number" defaultValue="1.5" />
            </div>
            <div>
          ...
          <div className="mt-4 space-y-3 text-sm">
            <div className="flex items-center justify-between rounded-lg border border-border bg-surface-muted px-4 py-3">
              <div>
                ...
                <div className="text-xs text-muted-foreground">Required for all operators</div>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="flex items-center justify-between rounded-lg border border-border bg-surface-muted px-4 py-3">
              <div>
                <div className="font-medium">SSO (Microsoft 365)</div>
                <div className="text-xs text-muted-foreground">Connected to mina-bahari.id</div>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="flex items-center justify-between rounded-lg border border-border bg-surface-muted px-4 py-3">
              <div>
                <div className="font-medium">Audit log export</div>
                <div className="text-xs text-muted-foreground">
                  Weekly export to compliance bucket
                </div>
              </div>
              <Switch />
            </div>
